...
- [x] **Phase 11: Role Management** - `list_roles` / `create_role` / `update_role` / `delete_role` / `assign_role` / `unassign_role` with built-in-role protection (completed 2026-05-21)
...
| 11. Role Management | v3.1.0 | 3/3 | Complete   | 2026-05-21 |
</content>
