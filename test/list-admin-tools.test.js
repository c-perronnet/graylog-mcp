...
test("list_admin_tools with no args returns all 101 tools grouped by domain", async () => {
    ...
    assert.equal(payload.count, 101, `expected 101 tools (91 v3.0.0 + get_entity_shares + list_grantees + share_entity + 7 role tools: list_roles/get_role/create_role/update_role/delete_role/assign_role/unassign_role), got ${payload.count}`);
